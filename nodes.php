...
while($row2 = $result2->fetch_assoc()) {
  ...
  if ($lat!=""&&$lon!=""){
	...
	$html=$html.$ip32;
	$html=$html."<a href=\"./adviser/?name=".$row2['name']."\" target=\"_blank\">Ruta optima cap a Guifi.Net</a><br>";
	$html=$html."<a href=\"./adviser/?name=".$row2['name']."&mode=inet\" target=\"_blank\">Ruta optima cap a Internet</a><br>";
	if ($row2["uptime"]!=""){
